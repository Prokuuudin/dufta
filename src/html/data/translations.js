const translations = {
  ru: {
    "desc-content": "Erawadee - Тайская традиционная медицина и косметика в Латвии",
    "keywords-content":
      "Erawadee, тайская медицина, тайская косметика, традиционная медицина, натуральная косметика, интернет-магазин, Латвия",
    "landing-title": "Erawadee - Тайская традиционная медицина и косметика в Латвии",
    ...
    "numbers-traffic-text":
      "ежедневный трафик на ERAWADEE.com",
  ...
  "tradition-card2-text": "Богатая мифология Таиланда отражает глубокие духовные и культурные ценности, передающиеся из поколения в поколение. Один из её центральных символов — Эраван (Airavata), величественный трёхголовый слон и священное ездовое животное бога Индры, покровителя дождя, грома и плодородия. В тайской традиции Эраван олицетворяет мудрость, благополучие, защиту и гармонию с природой.\n\nЛегенда гласит, что Эраван появился во время «взбивания Молочного океана», когда боги и демоны искали эликсир бессмертия. Его три головы символизируют единство прошлого, настоящего и будущего, а также баланс между небом, землёй и подземным миром — основу тайского мировосприятия. В Таиланде образ слона, особенно белого, издавна считается знаком небесного благословения, процветания и справедливого правления.\n\nВажную роль в мифологии играет и его мать — небесная слониха Иравати, воплощающая силу, сочувствие и материнскую любовь.\n\nОбраз Эравана и сегодня живёт в культуре Таиланда — ему посвящены храмы и священные места, куда люди приходят с молитвами о здоровье, любви и благополучии. Эта древняя легенда вдохновила создателей бренда ERAWADEE объединить мудрость и силу культурного наследия Таиланда с уважением к природе, балансу и внутренней гармонии человека.",
    ...
    "awards-text":"За вклад в сохранение и популяризацию тайского наследия компания Erawadee отмечена многими наградами:",   
    ...
    "awards-subtext":"*Примечание: ASEAN — Ассоциация государств Юго-Восточной Азии, в которую входят Индонезия, Малайзия, Филиппины, Сингапур, Таиланд, Бруней, Вьетнам, Лаос, Мьянма, Камбоджа.",
    ...
    "delivery-text":
      ...
      "delivery-more": "Подробнее — по ссылке на раздел доставки в интернет-магазине.",
    ...
    "payment-more": "Подробнее — по ссылке на раздел оплаты в интернет-магазине.",
  ...
  lv: {
    ...
    "keywords-content": "Erawadee, Taizemes medicīna, Taizemes kosmētika, tradicionālā medicīna, dabīgā kosmētika, interneta veikals, Latvija",
    ...
    "distribution-text":
      ...
      "distribution-contact-text": "Sazinieties ar mums, lai apspriestu partnerību",  
    ...
    "numbers-traffic-text":
      "ikdienas trafiks ERAWADEE.com vietnē",
    ...
    "awards-text":"Par ieguldījumu Taizemes mantojuma saglabāšanā un popularizēšanā uzņēmums Erawadee ir saņēmis vairākus apbalvojumus:",   
    ...
    "awards-subtext":"*Piezīme: ASEAN — Dienvidaustrumu Āzijas Valstu Asociācija, kurā ietilpst Indonēzija, Malaizija, Filipīnas, Singapūra, Taizeme, Brunēja, Vjetnama, Laosa, Mjanma, Kambodža.",
    ...
    "delivery-text":
      ...
      "delivery-more":  "Sīkāka informācija ir sadaļā par piegādi interneta veikalā.",
    ...
    "payment-item-visa-mastercard": "Maksājums ar Visa kartēm no jebkuras bankas",
    "payment-item-mastercard": "Maksājums ar Mastercard kartēm no jebkuras bankas",
    "payment-item-paypal": "PayPal",
  ...
  en: {
    ...
    "awards-text":"For its contribution to the preservation and promotion of Thai heritage, Erawadee has received numerous awards:",
    ...
    "awards-subtext":"*Note: ASEAN — Association of Southeast Asian Nations, which includes Indonesia, Malaysia, the Philippines, Singapore, Thailand, Brunei, Vietnam, Laos, Myanmar, Cambodia.",
    ...
    "delivery-text":
      ...
      "delivery-more": "Details are available in the delivery section of the online store.",
    ...
    "payment-more": "More details in the corresponding section of the online store.",
